...
public class SellerListController implements Initializable, DataChangeListener {
  ...
  public void onButtonNewAction(ActionEvent event) {
    ...
    createDialogForm(dep, "/gui/SellerForm.fxml", Utils.getCurrentStage(event));
  }
  ...
  private void initEditButtons() {
    ...
    tableColumnEDIT.setCellFactory(param -> new TableCell<>() {
      ...
      protected void updateItem(Seller obj, boolean empty) {
        ...
        setGraphic(button);
        button.setOnAction(event -> createDialogForm(obj, "/gui/SellerForm.fxml", Utils.getCurrentStage(event)));
      }
    });
  }
